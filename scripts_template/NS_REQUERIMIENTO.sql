...
SET @mmNoFolios = [dbo].[GetFieldRequest](@mmId_request, 'NS_NOFOLIOS_SG', NULL, 'value', 7)

SET @mmObservacion = [dbo].[GetFieldRequest](@mmId_request, 'NS_OBSERVACIONREV_SG', NULL, 'value', 7)
...
SET @mmFechaRequerimiento = CONVERT(DATE,[dbo].[GetFieldRequest](@mmId_request, 'NS_FECHAREQUERIMIENTO', NULL, 'value', 7) )
